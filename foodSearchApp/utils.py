...
def get_food_detail_data(lat, lng, unique_search_id, page_no):
    ...
    logger.info("[PRICE DATA] Exit from get_food_detail_data")
    return food_detail_data, page_no, False
This is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is lineThis is line